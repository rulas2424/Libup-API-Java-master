...
public class NotificateLosers {
    ...
    public static String sendNotificationsLosers(List<String> deviceTokens, String typeNotification, String awardConsolation, String commerceName, String idCommerce, String imageLoser, String imageCommerce) throws IOException {
        ...
        try {
            ...
            data.put("message", ConstantsTexts.LOSER_MSG);
            data.put("hour", ConstantsTexts.hour.format(date));
            data.put("type", typeNotification);
            data.put("awardConsolation", awardConsolation);
            data.put("commerceName", commerceName);
            data.put("idCommerce", idCommerce);
            data.put("imageLoser", imageLoser);
            data.put("imageCommerce", imageCommerce);
            json.put("data", data);
